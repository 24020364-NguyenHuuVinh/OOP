...
public class StringCodeTest {
	...
	@Test
    public void testIntersect_BasicMatch() {
        assertTrue(StringCode.stringIntersect("abcdef", "cdefgh", 3));
    }

    @Test
    public void testIntersect_BasicMismatch() {
        assertFalse(StringCode.stringIntersect("abcdef", "mnofgh", 3));
    }

    @Test
    public void testIntersect_BasicMismatch2() {
        assertFalse(StringCode.stringIntersect("abc", "mnofgh", 4));
    }
}
